...
class Notepad  implements ActionListener,DocumentListener,UndoableEditListener
{
	...
	Image image=toolkit.createImage("notepad1.png");//返回从指定文件获取像素数据的图像。返回的 Image 是一个新对象
	...
	public Notepad()
	{
		...
		frame.setIconImage(image);//设置要作为此窗口图标显示的图像。
		...
		this.text.addKeyListener(new KeyAdapter(){//在文本框加入键盘监听器，当键盘在文本框输入时，文本改变为true
		public void keyTyped(KeyEvent e)
			{
			   isTextChange=true;
			}
	...
	public void setKeyBoardShortCuts()//设置快捷键
	{
		...
		item[1][2].setAccelerator(KeyStroke.getKeyStroke('X',Event.CTRL_MASK));
		item[1][3].setAccelerator(KeyStroke.getKeyStroke('C',Event.CTRL_MASK));
		item[1][4].setAccelerator(KeyStroke.getKeyStroke('V',Event.CTRL_MASK));
	...
	{
		but[0].setIcon(new ImageIcon("new.png"));//以下几行设置按钮可用时图标
		but[1].setIcon(new ImageIcon("open.gif"));
		but[2].setIcon(new ImageIcon("save.png"));
		but[3].setIcon(new ImageIcon("saveas.gif"));
		but[4].setIcon(new ImageIcon("print.png"));
		but[5].setIcon(new ImageIcon("undo.png"));
		but[6].setIcon(new ImageIcon("redo.png"));
		but[7].setIcon(new ImageIcon("cut.png"));
		but[8].setIcon(new ImageIcon("copy.png"));
		but[9].setIcon(new ImageIcon("paste.png"));
		but[10].setIcon(new ImageIcon("delete.png"));
		but[11].setIcon(new ImageIcon("search.png"));
		but[12].setIcon(new ImageIcon("date.png"));
		but[13].setIcon(new ImageIcon("font.png"));
		but[14].setIcon(new ImageIcon("bold.png"));
		but[15].setIcon(new ImageIcon("italic.png"));
		but[16].setIcon(new ImageIcon("fontcolor.png"));
		but[17].setIcon(new ImageIcon("backgroundcolor.png"));
		but[18].setIcon(new ImageIcon("help.png"));
		menu[0].setIcon(new ImageIcon("file.gif"));//以下几行设置菜单图标
		menu[1].setIcon(new ImageIcon("edit.png"));
		menu[2].setIcon(new ImageIcon("format.png"));
		menu[3].setIcon(new ImageIcon("show.png"));
		menu[4].setIcon(new ImageIcon("help.png"));
		item[0][0].setIcon(new ImageIcon("new.png"));//以下几行设置项目可用图标
		item[0][1].setIcon(new ImageIcon("open.gif"));
		item[0][2].setIcon(new ImageIcon("save.png"));
		item[0][3].setIcon(new ImageIcon("saveas.gif"));
		item[0][5].setIcon(new ImageIcon("print.png"));
		item[0][6].setIcon(new ImageIcon("exit.gif"));
		item[1][0].setIcon(new ImageIcon("undo.png"));
		item[1][1].setIcon(new ImageIcon("redo.png"));
		item[1][2].setIcon(new ImageIcon("cut.png"));
		item[1][3].setIcon(new ImageIcon("copy.png"));
		item[1][4].setIcon(new ImageIcon("paste.png"));
		item[1][5].setIcon(new ImageIcon("delete.png"));
		item[1][6].setIcon(new ImageIcon("search.png"));
		item[1][7].setIcon(new ImageIcon("search.png"));
		item[1][8].setIcon(new ImageIcon("replace.png"));
		item[1][9].setIcon(new ImageIcon("goto.png"));
		item[1][10].setIcon(new ImageIcon("selectall.png"));
		item[1][11].setIcon(new ImageIcon("date.png"));
		item[2][0].setIcon(new ImageIcon("font.png"));
		colorItem[0].setIcon(new ImageIcon("fontcolor.png"));//颜色按钮的图标
		colorItem[1].setIcon(new ImageIcon("backgroundcolor.png"));
		colorMenu.setIcon(new ImageIcon("color.png"));
		item[1][0].setDisabledIcon(new ImageIcon("undo1.png"));//设置不可撤销图标
        item[1][1].setDisabledIcon(new ImageIcon("redo1.png"));//以下几行设置复制、剪切、粘贴、删除不可用时图标
    	item[1][2].setDisabledIcon(new ImageIcon("cut1.png"));//以下几行设置复制、剪切、粘贴、删除不可用时图标
		item[1][3].setDisabledIcon(new ImageIcon("copy1.png"));
		item[1][4].setDisabledIcon(new ImageIcon("paste1.png"));
		item[1][5].setDisabledIcon(new ImageIcon("delete1.png"));
		but[5].setDisabledIcon(new ImageIcon("undo1.png"));//设置不可撤销图标
		but[6].setDisabledIcon(new ImageIcon("redo1.png"));
		but[7].setDisabledIcon(new ImageIcon("cut1.png"));
		but[8].setDisabledIcon(new ImageIcon("copy1.png"));
		but[9].setDisabledIcon(new ImageIcon("paste1.png"));
		but[10].setDisabledIcon(new ImageIcon("delete1.png"));
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if("关于记事本(A)".equals(command))//弹出信息对话框
			JOptionPane.showMessageDialog(this.frame,"版权：嘉应学院中1E502！","关于记事本",JOptionPane.INFORMATION_MESSAGE,new ImageIcon("roommate.png"));
